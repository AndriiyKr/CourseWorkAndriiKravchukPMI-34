...
// 1. Огортаємо компонент у forwardRef
const GraphCanvas = forwardRef(({ 
  ...
  onOpenRenameModal,
  onAddNode
}, ref) => { // 2. Приймаємо ref як другий аргумент
  ...
  return (
    // 3. Додаємо переданий ref до головного div компонента
    <div ref={ref} className="w-full h-full bg-white rounded-2xl shadow-inner border border-slate-200 overflow-hidden select-none">
      <svg 
        ref={svgRef} 
